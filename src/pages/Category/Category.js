...
function App() {
  ...
  function moveCategory(event) {
    if (event.target.innerText === '패션')
      window.location.href = 'http://54.180.151.218:3000/category/fashion';
    if (event.target.innerText === '패턴&질감')
      window.location.href = 'http://54.180.151.218:3000/category/pattern';
    if (event.target.innerText === '여행')
      window.location.href = 'http://54.180.151.218:3000/category/travel';
    if (event.target.innerText === '동물')
      window.location.href = 'http://54.180.151.218:3000/category/animal';
    if (event.target.innerText === '애니메이션')
      window.location.href = 'http://54.180.151.218:3000/category/animation';
    if (event.target.innerText === '디자인')
      window.location.href = 'http://54.180.151.218:3000/category/design';
    if (event.target.innerText === '조소/공예')
      window.location.href = 'http://54.180.151.218:3000/category/craft';
    if (event.target.innerText === '사운드')
      window.location.href = 'http://54.180.151.218:3000/category/sound';
    if (event.target.innerText === '헬로! 아티스트')
      window.location.href = 'http://54.180.151.218:3000/category/helloartist';
  }
